...
function JobCard(props) {
  ...
  return (
    <div className="mx-40 mb-4">
        <div className="flex justify-between items-center px-6 py-4 bg-zinc-200 rounded-md border border-black shadow-lg hover:border-blue-500 hover:translate-y-2 hover:scale-103">
            <div className="flex flex-col items-start gap-3">
                <h1 className="text-lg font-semibold">{props.title} - {props.Company}</h1>
                <p>Full Time &#x2022; Fresher &#x2022; {props.location}</p>
            ...
            <div className="flex items-center gap-4">
                <p className="text-gray-500">Posted {diffday} {diffday > 1? "days": "day"} ago</p>
